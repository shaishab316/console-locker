export const TradeInTemplate = {
  ...
  welcome: ({ cName = '', pName = '' }) => /* html */ `<!doctype html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Welcome - Console Locker</title>
        <style>
          /* Reset styles */
          body,
          table,
              ...
              >
                ...
                <tr>
                  <td class="content" style="padding: 40px 30px">
                    ...
                    <p
                      ...
                      "
                    >
                      Welcome to <strong>Console Locker</strong>! We're excited that you've chosen to trust us with your gaming console.
                    </p>
                    ...
                    <p
                      ...
                      "
                    >
                      Your request to sell the <strong>${pName}</strong> has been received successfully. Our team will review the details and get back to you shortly.
                    </p>
                      ...
                      <tr>
                        <td>
                          ...
                          <p
                            ...
                            "
                          >
                            Selling your used console helps reduce electronic waste and supports a sustainable gaming future.
                          </p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <p
                      ...
                      "
                    >
                      If you have any questions or need assistance in the meantime, feel free to reach out to our support team.
                    </p>
                ...
                <tr>
                  ...
                  >
                    ...
                    <p style="color: #cccccc; margin: 15px 0 0 0; font-size: 11px">
                      © ${new Date().getFullYear()} Console Locker. All rights reserved.
                    </p>
                  </td>
                </tr>
              </table>
